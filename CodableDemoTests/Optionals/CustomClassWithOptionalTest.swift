//
//  CustomClassWithOptionalTest.swift
//  CodableDemoTests
//
...
class CustomClassWithOptionalTests: XCTestCase {
    
    func testBasicClassWithNilAsStringValue() {
        
        // Setup testcase
        
        let objectToSave = CustomClassWithNilValueOK(1)
        ...
        let objectLoaded = try! unarchiver.decodeTopLevelDecodable(CustomClassWithNilValueOK.self, forKey: NSKeyedArchiveRootObjectKey)
