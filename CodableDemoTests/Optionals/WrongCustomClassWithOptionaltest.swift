//
//  CustomClassWithOptionalTests.swift
//  CodableDemoTests
//
...
class WrongCustomClassWithOptionalTests: XCTestCase {
    
    func testBasicClassWithNilAsStringValue() {
        
        // Setup testcase
        
        let objectToSave = CustomClassWithNilValueWrong(1)
        ...
        let objectLoaded = try! unarchiver.decodeTopLevelDecodable(CustomClassWithNilValueWrong.self, forKey: NSKeyedArchiveRootObjectKey)
